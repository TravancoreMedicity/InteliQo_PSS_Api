...
module.exports = {
    ...
    getLevel1Hierarchy: (id, callBack) => {
        pool.query(
            ...
            authorization_incharge,
            authorization_hod
            FROM hrm_hierarchylevel_master 
    ...
    getInchargeAppraisalList: (data, callBack) => {
        pool.query(
            `SELECT appraisal_rights_detl.em_id,appraisal_rights_detl.em_no,em_name,hrm_dept_section.sect_name,appraisal_type FROM appraisal_rights_detl
